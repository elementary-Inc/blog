...
author: danrabbit
image: https://cdn-images-1.medium.com/max/1600/1*mxJZMz1YWtF3AAmI8f72Qw.png
tags:
 - year-in-review
 - meta
---
...
![Sunset over the beach in Almería, Spain](https://cdn-images-1.medium.com/max/2560/1*Bgg5YZMYAD23qp7oui1HXQ.jpeg)
</figure>
...
As Cassidy has said before, “[AppCenter is the center of our platform]({{ site.baseurl }}{% post_url 2017-02-08-building-the-future-of-elementary-os %})”. In 2018 we reached [a total of 123](https://appcenter.elementary.io/) curated, native, Open Source apps in AppCenter—and that number is still growing.

<figure markdown="1">
![With the release of Juno, we gave developers a new tool to raise funds](https://cdn-images-1.medium.com/max/800/1*S9MbyJZj1Ao8gB9wh9lKJA.png){: srcset="https://cdn-images-1.medium.com/max/1600/1*S9MbyJZj1Ao8gB9wh9lKJA.png 2x"}
<figcaption>With the release of Juno, we gave developers a new tool to raise funds</figcaption>
</figure>

This last year, in the interest of pursuing our goal of funding the development of Open Source apps, we made a major change to the way we take payments in AppCenter. You can [read the full story here]({{ site.baseurl }}{% post_url 2018-02-05-about-appcenter-payments %}), but the short version is that we gave developers a way to ask again when users decide to try their app for free without being annoying or restrictive. No naggy pop-ups, no trial versions, just a gentle reminder to fund the development of your favorite apps when you update them.

<figure markdown="1">
![AppCenter apps can now be viewed online at [appcenter.elementary.io](https://appcenter.elementary.io/)](https://cdn-images-1.medium.com/max/800/1*pr7sXp8pnSHtdAy6Tsr7-g.png){: srcset="https://appcenter.elementary.io/)](https://cdn-images-1.medium.com/max/837/1*pr7sXp8pnSHtdAy6Tsr7-g.png 2x"}
...
<figure markdown="1">
![Content warnings in AppCenter](https://cdn-images-1.medium.com/max/479/1*CIDjfzbvL5m8tRyeoAfVvw@2x.png){: srcset="https://cdn-images-1.medium.com/max/958/1*CIDjfzbvL5m8tRyeoAfVvw@2x.png 2x"}
<figcaption>Content warnings in AppCenter</figcaption>
</figure>

As we grow our platform, we’re also thinking about how people can curate the kind of content that they and their loved ones are exposed to when browsing AppCenter. While we have lofty plans for more fine-grained controls in the future, we started out by introducing a simple content warning for apps that may contain explicit or sensitive content. You can read more about that [here]({{ site.baseurl }}{% post_url 2018-09-24-appcenter-and-content-ratings %}).
...
<figure markdown="1">
![How neat is that?](https://cdn-images-1.medium.com/max/490/1*E7eG-Oulby8kw0gxdsA85A.gif)
...
<figure markdown="1">
![The new shortcut overlay makes discovering powerful shortcuts easier](https://cdn-images-1.medium.com/max/800/1*yMwL9DoWZHg5tuExy8uOVw@2x.png){: srcset="https://cdn-images-1.medium.com/max/1600/1*yMwL9DoWZHg5tuExy8uOVw@2x.png 2x"}
...
<figure markdown="1">
![Each month Juno saw major improvements and redesigns for System Settings](https://cdn-images-1.medium.com/max/800/1*xTzUS56g8ApfQ3Zpu36xdw@2x.png){: srcset="https://cdn-images-1.medium.com/max/1600/1*xTzUS56g8ApfQ3Zpu36xdw@2x.png 2x"}
...
![](https://cdn-images-1.medium.com/max/800/1*7k_OvKGZUZNH5O38TlzpcA@2x.png){: srcset="https://cdn-images-1.medium.com/max/1484/1*7k_OvKGZUZNH5O38TlzpcA@2x.png 2x"}
...
<figure markdown="1">
![Some of the changes to file type icons in Juno](https://cdn-images-1.medium.com/max/480/1*C0Yw6nRrlzd-T3ZxRL_UQw.png){: srcset="https://cdn-images-1.medium.com/max/960/1*C0Yw6nRrlzd-T3ZxRL_UQw.png 2x"}
...
<figure markdown="1">
![A new stylesheet feature made these fancy colored sliders in Photos possible](https://cdn-images-1.medium.com/max/356/1*hhen9esPotrlkFuvbh85tQ@2x.png){: srcset="https://cdn-images-1.medium.com/max/712/1*hhen9esPotrlkFuvbh85tQ@2x.png 2x"}
...
![](https://cdn-images-1.medium.com/max/800/1*mxJZMz1YWtF3AAmI8f72Qw.png){: srcset="https://cdn-images-1.medium.com/max/1600/1*mxJZMz1YWtF3AAmI8f72Qw.png 2x"}

But we didn’t stop there! We came back right away in [November]({{ site.baseurl }}{% post_url 2018-11-30-juno-updates-for-november-2018 %}) and [December]({{ site.baseurl }}{% post_url 2019-01-01-juno-updates-for-december-2018 %}) with more updates, more features, and more fixes. Juno’s story has just begun, and will continue going strong throughout 2019.
