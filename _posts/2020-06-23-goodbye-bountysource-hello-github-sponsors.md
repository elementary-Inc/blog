...
In December, 2017, [Bountysource was acquired](https://web.archive.org/web/20191008103840/https://blog.canya.com/2017/12/20/canya-acquires-majority-stake-in-bountysource-adds-over-46000-users/) by a cryptocurrency company called CanYa who redesigned the Bountysource site and service with a new cryptocoin focus. In the time since, the quality of service and support has gone downhill with long lead times—especially when dealing with payouts or issues. These events have led us to re-think our relationship with and recommendation of Bountysource. As such, we've removed Bountysource from our website, removed any Bountysource integration with elementary repos on GitHub, withdrawn our funds, and closed our account.

For backers and bounty hunters on Bountysource, **we recommend you also withdraw your funds and close your account** by emailing [support@<wbr>bountysource.com](mailto:support@bountysource.com) as soon as possible. The future of Bountysource is unclear, and the new ownership has demonstrated they are willing to take advantage of your funds if given the chance.
