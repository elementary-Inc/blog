...
In June, we said [Goodbye to Sourceforge]({{ site.baseurl }}{% post_url 2015-06-17-goodbye-sourceforge %}) and “Hello” to our very own brand new CDN which has already served up over a million downloads; That’s more than a petabyte of data! We now have several localized servers and confidently serve up speedy downloads to our users, ad free.
