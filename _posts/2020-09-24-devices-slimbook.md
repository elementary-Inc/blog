...
This brings the total to over two dozen models from different retailers. For more background on our work with OEMs—including why it's so important to the user experience—see our [Now Shipping elementary OS](/now-shipping-elementary-os) blog post.
