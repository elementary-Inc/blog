...
And finally, we have a goal to **release elementary OS 6** in 2020—I know, that _almost_ sounds like a release date—even if we have to delay some originally-planned features to a 6.1 update later on.
