...
image: /assets/images/developer-tips-backgrounding-system-integration/1jDmdgKEQLIezltJm9ado3Q@2x.png
tags:
  - "tips"
  - "elementary-os"
  - "system-integration"
...
<figure markdown="1">
![Static QuickLists always display in the Dock and Applications Menu, whether or not the app is open.](/assets/images/developer-tips-backgrounding-system-integration/1JdWxGcPc2mGBgqrve0iGVQ@2x.png)
...
<figure markdown="1">
![Badges show up in the Dock and Applications Menu.](/assets/images/developer-tips-backgrounding-system-integration/1em7pQMjB6Qwqwgpw6tiNtA@2x.png)
<figcaption markdown="1">
...
<figure markdown="1">
![Progress bars show up on the Dock, whether your app window is open or not.](/assets/images/developer-tips-backgrounding-system-integration/1jix8w-7loepONezUWTnl8g@2x.png)
<figcaption markdown="1">
...
<figure markdown="1">
![Notifications pop up at the top-right of the primary display.](/assets/images/developer-tips-backgrounding-system-integration/1jDmdgKEQLIezltJm9ado3Q@2x.png)
<figcaption markdown="1">
...
<figure markdown="1">
![System Indicators are displayed based on context.](/assets/images/developer-tips-backgrounding-system-integration/10iHJswGZTVsPDsdaCyxN1w@2x.png)
<figcaption markdown="1">
