...
date: '2017-02-20T04:46:43.539Z'
categories: []
keywords: []
slug: /@cassidyjames/secure-by-default-689abcac6c66
---
...
In that vein, I’d like to double down on pointing users to more secure decisions out of the box in elementary OS — and really any other modern OS. A core idea behind this is _Secure by Default_.
...
![Flatpak, a sandboxed app format.](https://cdn-images-1.medium.com/max/800/0*psp5yAl8MY9TBmCl.png)
...
![Unsecured becomes insecure. Secure becomes standard.](https://cdn-images-1.medium.com/max/800/1*tYEdjk26OO5zkSXxWztBiQ.png)
Unsecured becomes insecure. Secure becomes standard.

Instead, modern OSes should display secure, encrypted networks as the default while clearly and strongly denoting unsecured (and possibly “secured” but using outdated/easily-cracked encryption) as insecure. This helps users get used to the _Secure by Default_ mentality, marking insecure WiFi the exception rather than the rule.
...
![elementary OS now shows encrypted networks as default, and unencrypted networks as insecure](https://cdn-images-1.medium.com/max/800/1*OaRjz_XfzUkbM3jxdnbXKg.jpeg)
...
![Our OS already knows when these services are being used. It could let users know, too.](https://cdn-images-1.medium.com/max/800/1*I3s_8EVor7RXbwPOLpU__w.png)
...
![](https://cdn-images-1.medium.com/max/400/1*jW0sgQPivOWSstkEGpxrXw.jpeg)
![](https://cdn-images-1.medium.com/max/400/0*5S9Ufr3oDwNR65nm.png)
![Android tattletales on apps using the camera or microphone. Image from [AndroidPolice.com](https://www.androidpolice.com/2018/05/09/android-p-notifications-apps-running-background-show-theyre-using-camera-microphone/#ap-lightbox).](https://cdn-images-1.medium.com/max/400/1*jW0sgQPivOWSstkEGpxrXw.jpeg)
