...
date: '2018-02-19T16:25:20.828Z'
categories: []
keywords: []
slug: /@cassidyjames/secure-by-default-disk-encryption-3592bf25e3ce
---

![](https://cdn-images-1.medium.com/max/800/1*g1QNuj3lgSnsF-sgNAueHg@2x.png)
...
The wrench with encryption is that the end user _must_ technically reinstall their OS in order to encrypt the disk with a unique password. Since we had been floating the idea of recovery partitions as part of the install, we realized this could provide us with a solution.
...
![](https://cdn-images-1.medium.com/max/600/1*kzq6V43rDSOQyXWUA6aqpw.png)
![New Disk Encryption prototype views](https://cdn-images-1.medium.com/max/600/1*U0hNITzCI_nx2NX5nTImwA.png)
...
2.  Clearly and honestly explain the implications, whether or not the user might fully understand disk encryption.
3.  Allow users to opt out of encryption if they have a good reason.
...
2.  Possibly syncing/adding passwords for additional admin users (though this might be technically difficult/infeasible due to the many ways you can set a password on a Linux-based OS)
3.  Ensuring the power-on password entry looks as good and works as well as it can across different OSes and hardware combinations
...
So, in a nutshell, _When It’s Ready™_ as usual. But stay tuned for some more info about the installer itself soon! In the meantime, you can always dig into it [on GitHub](https://github.com/elementary/installer/wiki).
