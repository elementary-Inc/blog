...
date: '2018-07-23T16:01:01.800Z'
categories: []
keywords: []
slug: /@cassidyjames/introducing-new-appcenter-sharing-urls-4da5ee92f12d
---
...
![Preview of a web-based app listing](https://cdn-images-1.medium.com/max/800/1*-HNF7ahBA3j_TNzgTBkYbA.png)
Preview of a web-based app listing

Anyone can link to or share this URL; if you’re an app developer and want to share your app on social media, this is a _great_ way to do that! Or if you’re just an excited user and want to show your friends, family, or followers a cool app, this is how to do it.
...
![](https://cdn-images-1.medium.com/max/800/1*_mzxdebxqeMgyDfAAHn5ug.png)
...
![The new “Open in AppCenter” dialog](https://cdn-images-1.medium.com/max/800/1*8rtpg7U9KEAFD5YDMjUoRw.png)
