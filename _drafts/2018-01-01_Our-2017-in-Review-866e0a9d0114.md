...
categories: []
keywords: []
slug: /@DanielFore/our-2017-in-review-866e0a9d0114
---
...
A snapshot of the redesigned Get Involved page
...
The new Developer page with AppCenter Dashboard
...
(From left to right) Daniel Foré, Cody Garver, Nathan Dyer, and Cassidy James Blaede
...
*   [So You Wanna Publish on AppCenter](https://medium.com/elementaryos/so-you-wanna-publish-on-appcenter-12c675b56e1c)
...
The updated App Info page with release descriptions, the share menu, and other apps by an author.

#### AppCenter Spotlight

As a part of our efforts around AppCenter, Cassidy kicked off the [AppCenter Spotlight](https://medium.com/elementaryos/tagged/appcenter-spotlight) series in April. Each month he’s looked at some of the best apps, interviewed their developers, and shared their stories. He’s also written a [pretty extensive year-end wrap up](https://medium.com/elementaryos/appcenter-spotlight-2017-wrap-up-3ab050256069); give it a read!
...
Left: Password creation feedback | Right: The redesigned About page
...
Some of the new file type icons
...
**In April**, we made a big change and [migrated all of our translations](https://medium.com/elementaryos/adios-transifex-weve-gone-to-weblate-59870dea06b2) from Transifex and Launchpad’s Rosetta to a self-hosted Weblate. We also took some time to re-enforce our values and clarify [our stance on advertising and tracking](https://medium.com/elementaryos/you-are-not-the-product-1d28c485175f).

**In June**, [we announced our decision](https://medium.com/elementaryos/elementary-github-bbd454eac547) to officially move our [nearly 100 code repositories](https://github.com/elementary) to GitHub. Since the move, we’ve not only seen increased contributions to our repositories, but more productive conversations in our issue tracker. Slack integration keeps us notified of changes and code reviews have never been easier. We’ve also set up Travis CI on the majority of our repos.

**In July**, we started [ReviewsDay Tuesdays](https://medium.com/elementaryos/reviewsdaytuesday-c9ab3fcd2144), in an effort to make sure code was getting reviewed in a timely manner. We also decided to [bid farewell to the About dialog](https://medium.com/elementaryos/peace-out-about-dialogs-8efa956c0562), opting instead to make app info pages in AppCenter much much better.
