...
date: '2018-03-31T17:27:31.911Z'
categories: []
keywords: []
slug: /@DanielFore/juno-progress-for-march-6fd2d553c237
---

As we steadily _march_ towards Juno’s release (Ha! See what I did there?) new features are landing in our unstable daily builds on a regular basis. Juno is shaping up to be a great release for developers and other heavy keyboard users with the introduction of a few new tricks:
...
![Tap ⌘ to see a list of system keyboard shortcuts](https://cdn-images-1.medium.com/max/1200/1*eE-aOnevYP5GOvwRpYANZw@2x.png)
...
![Choose your ⌘ key behavior in Layout settings](https://cdn-images-1.medium.com/max/1200/1*HTI993V-e8N_si2MYMwneA@2x.png)
...
![New mouse pointer acceleration settings, including “None”](https://cdn-images-1.medium.com/max/1200/1*Zfin7WuQbSRYLusrLrpwfg@2x.png)
...
![Discover nearby Bluetooth devices directly in System Settings](https://cdn-images-1.medium.com/max/1200/1*cCBuukzGxYC5XTcvldbAvw@2x.png)
...
![Apps now ask for permission before using location services](https://cdn-images-1.medium.com/max/800/1*7Wx2U9zdugDp8_xrQ03uug@2x.png)
...
![Location settings can be found in System Settings → Security & Privacy](https://cdn-images-1.medium.com/max/1200/1*LGiVLQbNEQFCdMdvsvcsBw@2x.png)
...
![New quick style options including a new dark mode](https://cdn-images-1.medium.com/max/1200/1*rVFtkMg5Y0-4tjPqjUecVQ@2x.png)
...
![Easily open files in external apps from the folder manager](https://cdn-images-1.medium.com/max/1200/1*hWu8Lg8XZj8WUUSInsbPdA@2x.png)
...
![](https://cdn-images-1.medium.com/max/600/1*RkPZ6ptWqwZL_IzvCJwVNQ@2x.png)
![](https://cdn-images-1.medium.com/max/600/1*zS9cuxUHKkfqxjPcicBTkw@2x.png)
...
![An updated payment dialog (with dummy information)](https://cdn-images-1.medium.com/max/800/1*BkzqqVP_Zk6LqiTO5U_UBQ@2x.png)
