...
description: >-
  Corentin Noël has proposed a cross-desktop URL scheme specification for system
  settings and we’re excited to announce the first release of…
date: '2016-12-08T17:54:43.343Z'
categories: []
keywords: []
slug: >-
  /@DanielFore/making-system-settings-access-a-cross-desktop-feature-c98eadcaea30
---

Corentin Noël has proposed a [cross-desktop URL scheme specification](https://docs.google.com/document/d/1N0uqNtVXEFn3cLgNMeN75mP_dpMpCco-7uw5PKow-_Q/edit?usp=sharing) for system settings and we’re excited to announce the first release of Switchboard (the system settings app in elementary OS) that makes use of it!

![](https://cdn-images-1.medium.com/max/800/0*740YNDjNe4M3AKOB.)
